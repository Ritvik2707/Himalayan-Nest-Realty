...
import { registerUser } from '../../handlers/AuthHandlers'
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="bg-white py-6 sm:py-8 px-4 sm:px-6 shadow rounded-lg">
                    ...
                    <div className="mt-6">
                        ...
                        <Link href="/login" className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
